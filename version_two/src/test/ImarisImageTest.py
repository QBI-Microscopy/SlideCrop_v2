...
class ImarisImageTest(unittest.TestCase):
    ...
    def test_two_dim_data(self):
        ...
        self.assertEqual(test_array.shape,(1, 1280, 640),
                         "get_two_dim_data tested with no region specified")

        test_array = self.Image.get_two_dim_data(self.lowest_res, [500, 500, 505, 505])
        self.assertEqual(test_array.shape,(1, 5,5),
                         "get_two_dim_data tested with region specified")
        self.assertEqual(test_array[0:5,0:5], [[11, 12, 13,  0,  0],
                                               [12, 10, 12,  0,  0],
                                               [10, 11, 11,  0,  0],
                                               [10, 12, 11,  0,  0],
                                               [11, 13, 11,  0,  0]],
    ...
    def test_get_euclidean_subset_in_resolution(self):
        ...
        self.assertEqual(test_array.shape, (2, 5, 5, 1, 1), "get_euclidean_subset_in_resolution returns correct shape"
                                                            " array")
        self.assertEqual(test_array[0, :, :, 0, 0], [[11, 12, 13,  0,  0],
                                                    [12, 10, 12,  0,  0],
                                                    [10, 11, 11,  0,  0],
                                                    [10, 12, 11,  0,  0],
                                                    [11, 13, 11,  0,  0]],
    ...
    def test_get_low_res_image(self):
        self.assertEqual(self.Image.get_low_res_image().shape, (1, 1280, 640), "get_low_res_image returns correct "
                                                                               "shaped array")
        self.assertEqual(self.Image.get_low_res_image()[0, 505:510, 500:505], [[13, 10, 11,  0,  0],
                                                                               [11, 11, 12,  0,  0],
                                                                               [11, 12, 12,  0,  0],
                                                                               [11, 11, 11,  8,  0],
                                                                               [11, 11, 12, 11,  0]]
,
    ...
    def test_resolution_dimensions(self, r):
        self.assertEqual(self.Image.resolution_dimensions(0), [1280, 640, 1, 3, 1], "resolution_dimensions returns"
                                                                                    "correct array")
